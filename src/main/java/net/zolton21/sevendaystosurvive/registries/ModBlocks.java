...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SYNAPTIC_SEAL_BLOCK = registerBlock("synaptic_seal", () -> new SynapticSealBlock(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN).lightLevel(state -> 15)));
